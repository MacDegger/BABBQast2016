...
import com.lifeboat.mobile.BABBQastPresentation.services.PresentationService;
import com.lifeboat.mobile.BABBQastPresentation.widgets.CustomCastPresentation;
import com.lifeboat.mobile.BABBQastPresentation.widgets.TouchView;
...
public class LandscapeActivity extends FragmentActivity {
    ...
    private String REMOTE_DISPLAY_APP_ID = "12345678"; //insert your own ChromeCast dev ID
    ...
    private BroadcastReceiver receiver = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent)
        {
            ...
            {
                mReady = true;
                if (framespeed.equals("16")){
                    mService.mFrameMillis = 16;
                } else if (framespeed.equals("32")){
                    mService.mFrameMillis = 32;
                }
                ...
                if (bg){
                    ...
                    mService.mPresentation.SetShowBG(false);
                }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        framespeed = getIntent().getStringExtra("framespeed");
        bg = getIntent().getBooleanExtra("bg", false);
        ...
        {
            if (bg) {
                ((TextView) titleCard.getChildAt(0)).setText("60 FPS w BG");
            } else {
        ...
        CastRemoteDisplayLocalService.startService(
                ...
                new CastRemoteDisplayLocalService.Callbacks() {
                    ...
                    public void onServiceCreated(CastRemoteDisplayLocalService castRemoteDisplayLocalService) {
                        //This triggers, but not when you want it to! We are forced to use a broadcast intent to ensure initialization has completed!
                    }
